...
public class CreateIndex {
    ...
    public static void main(String[] args) {
        ...
        news1.setContent("国家主席习近平9月3日在杭州西湖国际宾馆会见前来出席二十国集团领导人杭州峰会的美国总统奥巴马...");
        news1.setReply(672);
        //2
        News news2 = new News();
        news2.setId(2);
        ...
        try {
            ...
            doc2.add(new IntPoint("reply", news1.getReply()));
            doc2.add(new StoredField("reply_display", news1.getReply()));
